...
随着React Vue等框架的流行，Virtual DOM也越来越火，snabbdom是其中一种实现，而且Vue 2.x版本的Virtual DOM部分也是基于snabbdom进行修改的。snabbdom这个库核心代码只有200多行，非常适合想要深入了解Virtual DOM实现的读者阅读。如果您没听说过snabbdom，请先移步[官方文档](https://github.com/snabbdom/snabbdom)。
...
- 当状态更新时，用新的js对象和旧的js对象进行比较，得到两个对象之间的差异
- 将差异应用到真正的dom上
